...
const fieldLabels: Record<string, string> = {
  ...
  council_number: "registro no conselho",
  council_state: "UF do conselho",
  rqe: "RQE",
  default_service_id: "serviço padrão",
  default_room_id: "consultório padrão",
  telemedicine_enabled: "teleatendimento",
  accepts_new_patients: "aceite de novos pacientes",
  starts_at: "início",
  ends_at: "fim",
  ...
  valid_from: "validade inicial",
  valid_until: "validade final",
