...
const actionLabels: Record<string, string> = {
  ...
  clinical_route_decided: "Fluxo assistencial definido",
  clinical_route_corrected: "Fluxo assistencial corrigido",
  clinical_workflow_created: "Atendimento assistencial criado",
  clinical_workflow_sync_failed: "Falha ao iniciar atendimento assistencial",
  clinical_workflow_transitioned: "Etapa assistencial avançada",
...
const tableLabels: Record<string, string> = {
  ...
  clinic_professional_profiles: "Ficha profissional",
  appointment_workflow_events: "Histórico da consulta",
  clinical_encounters: "Atendimento assistencial",
  nursing_assessments: "Ficha de pré-consulta",
  nursing_preferences: "Preferências de Enfermagem",
  clinic_services: "Serviço",
  clinic_rooms: "Consultório",
  professional_availability_rules: "Disponibilidade profissional",
  registration_preferences: "Preferências de cadastro",
};
...
const fieldLabels: Record<string, string> = {
  ...
  preferred_contact: "Contato preferencial",
  postal_code: "CEP",
  ...
  health_plan_name: "Convênio",
  health_plan_number: "Carteirinha",
  health_plan_valid_until: "Validade do convênio",
  clinical_alerts: "Alertas clínicos",
  consent_lgpd_at: "Consentimento LGPD",
  active: "Ativo",
  code: "Código",
  name: "Nome",
  category: "Categoria",
  ...
  room_type: "Tipo de consultório",
  floor: "Andar ou setor",
  capacity: "Capacidade",
  resources: "Recursos",
  room_id: "Consultório",
  service_id: "Serviço",
